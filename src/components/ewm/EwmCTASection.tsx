      ...
      <div className="relative z-10 mx-auto max-w-[1200px] xl:max-w-[1440px] 2xl:max-w-[1720px] [@media(min-width:1920px)]:max-w-[1840px] px-5 sm:px-8 md:px-14 lg:px-20 xl:px-32 2xl:px-20 text-center">
        ...
        >
          ...
          <button
            ...
            className="w-full sm:w-auto px-6 py-3 text-sm font-medium rounded-none transition-colors hover:bg-white/5 text-center text-white inline-flex items-center justify-center cursor-pointer"
